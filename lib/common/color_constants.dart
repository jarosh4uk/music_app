...
class tColor{
  ...
  static Color get focusedStart => const Color(0xffED8770);

  static Color get secondaryEnd => const Color(0xff675DDF);
  ...
  static List<Color> get primaryG => [ focusedStart, focus];
